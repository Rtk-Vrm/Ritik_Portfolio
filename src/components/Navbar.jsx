...
const Navbar = () => {
  ...
  const handleNavLinkClick = (targetId) => {
    const navbarHeight = navbarRef.current.getBoundingClientRect().height; // Get the height of the navbar
  ...
  return (
    <Nav ref={navbarRef}>
      <NavbarContainer>
        <NavLogo to="/">
          <img src='rvLogo.png' alt="logo" style={{ width: '50px', height: '50px' }} />
          &nbsp; <ColorText>&lt;</ColorText>Ritik
          <div style={{ color: theme.primary }}>/</div>Verma
          <ColorText>&gt;</ColorText>
        </NavLogo>
